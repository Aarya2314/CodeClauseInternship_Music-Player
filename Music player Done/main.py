...
class Player(tk.Frame):
	...
	def track_widgets(self):
		...
		self.songtrack['text'] = 'Memorable MP3 player'
	...
	def retrieve_songs(self):
		...
		for root_, dirs, files in os.walk(directory):
				for file in files:
					if os.path.splitext(file)[1] == r'"C:\Users\SHREE\Documents\song\Song.mp3"':
...
root.wm_title('Codeclause_Music_Player')

img = PhotoImage(file=r"C:\Users\SHREE\Documents\Music player Done\img.png\background.gif")
next_ = PhotoImage(file = r"C:\Users\SHREE\Documents\Music player Done\img.png\icons8-next.gif")
prev = PhotoImage(file=r"C:\Users\SHREE\Documents\Music player Done\img.png\icons8-previous.gif")
play = PhotoImage(file=r"C:\Users\SHREE\Documents\Music player Done\img.png\icons8-play.gif")
pause = PhotoImage(file=r"C:\Users\SHREE\Documents\Music player Done\img.png\icons8-pause.gif")
